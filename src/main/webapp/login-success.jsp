        ...
        <div class="newsletter">
            ...
            <form action="#">
                ...
                <div class="newsletter-header">
                    ...
                    <h3 class="newsletter-title">Welcome, <span id="userName">[User Name]</span></h3>

                    <p class="newsletter-desc">
                        We're glad you're here, <b><span id="userNameRepeat">[User Name]</span></b>.
                        <br>Stay connected with us to get the latest updates and offers.
                    </p>
...
<%--            width: 80%;--%>
<%--            margin: 50px auto;--%>
<%--            background-color: #fff8dc; /* Lighter shade of gold for the container */--%>
<%--            padding: 20px;--%>
<%--            border-radius: 5px;--%>
...
<%--            background-color: #daa520; /* Lighter gold for hover effect */--%>
<%--        }--%>
<%--    </style>--%>
<%--</head>--%>
<%--<body>--%>
...
<%--    <p>Welcome, ${email}</p>--%>
<%--    <div>--%>
<%--        <a href="/admin/products" class="dashboard-link">Manage Products</a>--%>
<%--        <a href="/admin/orders" class="dashboard-link">View Orders</a>--%>
<%--        <a href="/admin/users" class="dashboard-link">User Management</a>--%>
<%--        <a href="/admin/reports" class="dashboard-link">Reports</a>--%>
